    ...
    <div class="container extra-class-container" style="margin: 1.5rem 0px !important; padding: 0 1rem;">
        <div class="row">
            <div class="col-md-4 col-6 header-col">
                <h3 class="heading">Admin Support System</h3>
            </div>
        ...
        <div class="parent-accordion p-3" id="parent-accordion">
            ...
            <div class="spinner2 d-flex justify-content-center" v-if="AllticketsLoading">
            ...
            <div v-else>
                <div class="table-responsive">
                    <table class="table table-striped ">
                        ...
                        <tbody>
                            <tr v-for="(items, index) in Alltickets" :key="index">
                    ...
                    <Bootstrap5Pagination :show-disabled=true :limit="5" :data="currentPagination"
                        @pagination-change-page="fetchAllTickets" />
                </div>
                <div v-if="Alltickets && Alltickets.length === 0" class="text" style="text-align: center; margin: 10px 0;">
                    No Chat Found
                </div>
            </div>
        </div>
...
export default {
    methods: {
        ...mapActions('support', ['fetchAllTickets']),
    ...
    computed: {
        ...mapState('support', ['Alltickets', 'AllticketsLoading', 'pagination']),
        currentPagination() {
            return this.pagination ? this.pagination : "no pagination";
        },
    },
    mounted() {
        this.fetchAllTickets(1);
    }
}
</script>
