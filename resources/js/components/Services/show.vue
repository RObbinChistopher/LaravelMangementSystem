    ...
    <div class="container extra-class-container" style="margin: 1.5rem 0px !important">
        <div class="row">
            <div class="col-md-4 col-12 header-col">
                <h3 class="heading">All Invoice</h3>
            </div>
                        ...
                        <tbody>
                            <tr v-for="(item, index) in filterServices">
                                ...
                                <td class="text2 d-flex gap-0">
                                    ...
                                    <router-link :to="{ name: 'editinvoice', params: { id: item.id } }">
                                        <button class="import2 add-cc btn-cc-dd hover-cc">
...
export default {
    ...
    methods: {
        ...mapActions('service', ['fetchAllServices', 'fetchdeleteServices', 'fetchAllServicesDetailsData', 'fetchFilttleByServices', 'fetchFilttleByServicesStatus',
        ...
        getServiceDisplayName(serviceValue) {
            return serviceValue ? serviceValue.name : 'No service selected'; // Return service name
        },
        handleServiceChange(service) {
            ...
            if (service === null) {
                ...
                // Pass service.id and page_number as an object
                this.fetchFilttleByServices({ service: service.id, page_number: 1 });
            }
        },
    ...
    computed: {
        ...mapState('service', ['service', 'servicesLoading', 'pagination', 'allserviceDetails']),
        currentPagination() {
